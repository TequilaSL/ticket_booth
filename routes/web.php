...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::group([
        ...
        Route::post('/current-country-code', 'Auth\LoginController@current_locale')->name('current_country_code');
        Route::post('/current-currency-code', 'Auth\LoginController@current_currency')->name('current_currency_code');
