        ...
        <div class="panel-body form-group-separated">
            ...
            @if(\Illuminate\Support\Facades\Storage::disk('s3')->exists('drivers/license/'.$driver['user_id'].'/front_side.'.$driver['front_side_extension']))
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-xs-7">
                        <img src="{{ \Illuminate\Support\Facades\Storage::url('drivers/license/'.$driver['user_id'].'/front_side.'.$driver['front_side_extension'], now()->addMinutes(5)) }}"
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-xs-7">
                        <img src="{{ \Illuminate\Support\Facades\Storage::url('drivers/license/'.$driver['user_id'].'/back_side.'.$driver['back_side_extension'], now()->addMinutes(5)) }}"
